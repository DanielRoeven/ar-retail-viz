            ...
            groups.data(examples)
                    ...
                    .append('g')
                        .attr('transform', function(d, i){
                            ...
                            switch(d['Context']) {
                                case 'B&M Retail':
                                    transform = transform + ', ' + (1000/5)*1 + (i*25);
                                    break;
                                case 'Online Retail':
                                    transform = transform + ', ' + (1000/5)*2 + (i*25);
                                    break;
                                case 'Retail Campaign':
                                    transform = transform + ', ' + (1000/5)*3 + (i*25);
                                    break;
                                case 'Expo':
                                    transform = transform + ', ' + (1000/5)*4 + (i*25);
                                    break;
                                default:
